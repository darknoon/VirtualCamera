//
//  VirtualCameraExtensionProvider.swift
...
class VirtualCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: VirtualCameraExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = VirtualCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class VirtualCameraExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
...
class VirtualCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = VirtualCameraExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
